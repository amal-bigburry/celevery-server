...
import { SellerSupportModel } from './infrastructerLayer/models/seller.support.schema';
...
import { BuyerSupportModel } from './infrastructerLayer/models/buyer.support.schema';
...
/**
 * ******************************************************************************************************
 * SellerSupportModule Class Definition
 * 
 * This class represents the SellerSupportModule for Bigburry Hypersystems LLP's support services ecosystem.
 * The module encapsulates all necessary elements required to manage support tickets and communication 
 * for sellers and buyers in a modular and maintainable fashion using the NestJS framework.
 * ******************************************************************************************************
 */
