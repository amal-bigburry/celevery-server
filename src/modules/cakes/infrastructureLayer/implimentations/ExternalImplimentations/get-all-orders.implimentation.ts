...
import { GetAllOrdersInterface } from '../../../applicationLayer/interfaces/get-all-orders.interface';
/**
 ...
 */
@Injectable()
export class IGetAllOrdersImplimentation implements GetAllOrdersInterface {
