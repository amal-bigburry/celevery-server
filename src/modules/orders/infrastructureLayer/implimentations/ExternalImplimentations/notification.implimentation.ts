 ...
 */
import { NotificationInterface } from '../../../applicationLayer/interfaces/notification.interface';
 ...
 */
@Injectable()
export class INotificationUseCaseImp implements NotificationInterface {
  /**
   * Constructor to inject the NotificationUseCase.
   * This use case is responsible for the core logic of sending notifications.
   */
  constructor(private readonly Notificationusecaes: NotificationUseCase) {}
  /**
