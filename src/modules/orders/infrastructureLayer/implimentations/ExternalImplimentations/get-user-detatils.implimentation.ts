...
import { GetUserDetailInterface } from '../../../applicationLayer/interfaces/get-user-details.interface';
 ...
 */
@Injectable()
export class IGetUserDetailsUsecaseImp implements GetUserDetailInterface {
  /**
   ...
   */
  async getuserdetail(user_id: string): Promise<UserEntity> {
    /**
